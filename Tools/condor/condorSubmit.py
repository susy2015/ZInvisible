...
def submit(datasets, refLumi, era, numfile=5, noSubmit=False, verbose=False, dataCollections=False, dataCollectionslong=False, goMakeEff=False, goMakeEffPhoton=False, goMakeBeff=False, goMakeSigEff=False, goMakeTopPlots=False, goTTPlots=False): 
    ...
    # TopTagger.cfg
    mvaFileName = ""
    with file(environ["CMSSW_BASE"] + "/src/ZInvisible/Tools/TopTaggerCfg_dev_2016/TopTagger.cfg") as meowttcfgFile:
    ...
    filestoTransferGMP = [environ["CMSSW_BASE"] + "/src/ZInvisible/Tools/makePlots", 
                          ...
                          environ["CMSSW_BASE"] + "/src/ZInvisible/Tools/TopTaggerCfg_dev_2016/TopTagger.cfg",
                          environ["CMSSW_BASE"] + "/src/ZInvisible/Tools/TopTaggerCfg_dev_2017/TopTagger.cfg",
                          environ["CMSSW_BASE"] + "/src/ZInvisible/Tools/TopTaggerCfg_dev_2018/TopTagger.cfg",
