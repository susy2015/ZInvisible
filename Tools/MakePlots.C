...
int main(int argc, char* argv[])
{
    ...
    auto makePDSPhoton = [&](const std::string& label, const std::string& sample="GJets", const std::string& cuts="passPhotonSelection;HTZinv>200") {return Plotter::DatasetSummary("GJets "+label, fileMap[sample], cuts, ""); };
    ...
    if (doZnunu)
    {
        ...
        for (const auto & style : styles)
        {
            ...
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_ht200_met250_met_"    + style, {makePDCGJetsZnunu("metWithPhoton",         style, legend_label, "HTZinv>200;metWithPhoton>250")}, {1, d}, "", 200, minPt,  maxPt,  log_scale, false, label_met, y_axis_label));
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_ht200_met250_metphi_" + style, {makePDCGJetsZnunu("metphiWithPhoton",      style, legend_label, "HTZinv>200;metWithPhoton>250")}, {1, d}, "", 200, minPhi, maxPhi, log_scale, false, label_phi, y_axis_label));
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_ht200_met250_ht_"     + style, {makePDCGJetsZnunu("HTZinv",                style, legend_label, "HTZinv>200;metWithPhoton>250")}, {1, d}, "", 200, 0.0, 2000.0,    log_scale, false, label_ht,  y_axis_label));
            ...
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_ht200_met250_dr_"     + style, {makePDCGJetsZnunu("dRjetsAndPhoton",       style, legend_label, "HTZinv>200;metWithPhoton>250")}, {1, d}, "", 200, 0, 10.0,        log_scale, false, label_dr,  y_axis_label));
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_baseline_met_"        + style, {makePDCGJetsZnunu("metWithPhoton",         style, legend_label, "passBaselineZinv")},             {1, d}, "", 200, minPt,  maxPt,  log_scale, false, label_met, y_axis_label));
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_baseline_metphi_"     + style, {makePDCGJetsZnunu("metphiWithPhoton",      style, legend_label, "passBaselineZinv")},             {1, d}, "", 200, minPhi, maxPhi, log_scale, false, label_phi, y_axis_label));
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_baseline_ht_"         + style, {makePDCGJetsZnunu("HTZinv",                style, legend_label, "passBaselineZinv")},             {1, d}, "", 200, 0.0, 2000.0,    log_scale, false, label_ht,  y_axis_label));
            ...
            vh.push_back(PHS("MC_GJets_ZJetsToNuNu_baseline_dr_"         + style, {makePDCGJetsZnunu("dRjetsAndPhoton",       style, legend_label, "passBaselineZinv")},             {1, d}, "", 200, 0, 10.0,        log_scale, false, label_dr,  y_axis_label));
        }
    }
