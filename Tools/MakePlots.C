    ...
    for (const auto& JetPtCut : JetPtCuts) 
    {
        ...
        if (doDataMCElectron)
        {
            ...
            for (const auto& cut : map_norm_cuts_low_dm)
            {
                ...
                vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_50to250_" + cut.first + histSuffix,                      {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_bestRecoZM},                       {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_0to400_" + cut.first + histSuffix,                       {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_bestRecoZM},                       {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_50to250_" + cut.first + histSuffix,        {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_Normalization_bestRecoZM},         {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_0to400_" + cut.first + histSuffix,         {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_Normalization_bestRecoZM},         {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_split_50to250_" + cut.first + histSuffix,  {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_Normalization_bestRecoZM_split},   {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_split_0to400_" + cut.first + histSuffix,   {dcData_Electron_LowDM_bestRecoZM,   dcMC_Electron_LowDM_Normalization_bestRecoZM_split},   {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
            ...
            for (const auto& cut : map_norm_cuts_high_dm)
            {
                ...
                vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_50to250_" + cut.first + histSuffix,                     {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_bestRecoZM},                     {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_0to400_" + cut.first + histSuffix,                      {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_bestRecoZM},                     {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_50to250_" + cut.first + histSuffix,       {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_Normalization_bestRecoZM},       {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_0to400_" + cut.first + histSuffix,        {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_Normalization_bestRecoZM},       {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_split_50to250_" + cut.first + histSuffix, {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_Normalization_bestRecoZM_split}, {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_split_0to400_" + cut.first + histSuffix,  {dcData_Electron_HighDM_bestRecoZM,   dcMC_Electron_HighDM_Normalization_bestRecoZM_split}, {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
            ...
            vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_noZPtCut_50to250" + histSuffix,                  {dcData_Electron_LowDM_bestRecoZM_noZPtCut,                  dcMC_Electron_LowDM_bestRecoZM_noZPtCut},                  {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_noZPtCut_50to250" + histSuffix,                 {dcData_Electron_HighDM_bestRecoZM_noZPtCut,                 dcMC_Electron_HighDM_bestRecoZM_noZPtCut},                 {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_noZPtCut_0to400" + histSuffix,                   {dcData_Electron_LowDM_bestRecoZM_noZPtCut,                  dcMC_Electron_LowDM_bestRecoZM_noZPtCut},                  {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_noZPtCut_0to400" + histSuffix,                  {dcData_Electron_HighDM_bestRecoZM_noZPtCut,                 dcMC_Electron_HighDM_bestRecoZM_noZPtCut},                 {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_noZPtCut_50to250" + histSuffix,    {dcData_Electron_LowDM_bestRecoZM_noZPtCut,                  dcMC_Electron_LowDM_Normalization_bestRecoZM_noZPtCut},    {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_noZPtCut_50to250" + histSuffix,   {dcData_Electron_HighDM_bestRecoZM_noZPtCut,                 dcMC_Electron_HighDM_Normalization_bestRecoZM_noZPtCut},   {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_noZPtCut_0to400" + histSuffix,     {dcData_Electron_LowDM_bestRecoZM_noZPtCut,                  dcMC_Electron_LowDM_Normalization_bestRecoZM_noZPtCut},    {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_noZPtCut_0to400" + histSuffix,    {dcData_Electron_HighDM_bestRecoZM_noZPtCut,                 dcMC_Electron_HighDM_Normalization_bestRecoZM_noZPtCut},   {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_50to250" + histSuffix,                           {dcData_Electron_LowDM_bestRecoZM,                           dcMC_Electron_LowDM_bestRecoZM},                           {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_50to250" + histSuffix,                          {dcData_Electron_HighDM_bestRecoZM,                          dcMC_Electron_HighDM_bestRecoZM},                          {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_bestRecoZM_0to400" + histSuffix,                            {dcData_Electron_LowDM_bestRecoZM,                           dcMC_Electron_LowDM_bestRecoZM},                           {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_bestRecoZM_0to400" + histSuffix,                           {dcData_Electron_HighDM_bestRecoZM,                          dcMC_Electron_HighDM_bestRecoZM},                          {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_50to250" + histSuffix,             {dcData_Electron_LowDM_bestRecoZM,                           dcMC_Electron_LowDM_Normalization_bestRecoZM},             {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_50to250" + histSuffix,            {dcData_Electron_HighDM_bestRecoZM,                          dcMC_Electron_HighDM_Normalization_bestRecoZM},            {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_LowDM_Normalization_bestRecoZM_0to400" + histSuffix,              {dcData_Electron_LowDM_bestRecoZM,                           dcMC_Electron_LowDM_Normalization_bestRecoZM},             {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Electron_HighDM_Normalization_bestRecoZM_0to400" + histSuffix,             {dcData_Electron_HighDM_bestRecoZM,                          dcMC_Electron_HighDM_Normalization_bestRecoZM},            {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
        ...
        if (doDataMCMuon)
        {
            ...
            for (const auto& cut : map_norm_cuts_low_dm)
            {
                ...
                vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_50to250_" + cut.first + histSuffix,                      {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_bestRecoZM},                       {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_0to400_" + cut.first + histSuffix,                       {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_bestRecoZM},                       {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_50to250_" + cut.first + histSuffix,        {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_Normalization_bestRecoZM},         {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_0to400_" + cut.first + histSuffix,         {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_Normalization_bestRecoZM},         {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_split_50to250_" + cut.first + histSuffix,  {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_Normalization_bestRecoZM_split},   {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_split_0to400_" + cut.first + histSuffix,   {dcData_Muon_LowDM_bestRecoZM,   dcMC_Muon_LowDM_Normalization_bestRecoZM_split},   {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
            ...
            for (const auto& cut : map_norm_cuts_high_dm)
            {
                ...
                vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_50to250_" + cut.first + histSuffix,                     {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_bestRecoZM},                     {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_0to400_" + cut.first + histSuffix,                      {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_bestRecoZM},                     {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_50to250_" + cut.first + histSuffix,       {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_Normalization_bestRecoZM},       {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_0to400_" + cut.first + histSuffix,        {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_Normalization_bestRecoZM},       {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_split_50to250_" + cut.first + histSuffix, {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_Normalization_bestRecoZM_split}, {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
                vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_split_0to400_" + cut.first + histSuffix,  {dcData_Muon_HighDM_bestRecoZM,   dcMC_Muon_HighDM_Normalization_bestRecoZM_split}, {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5, true, false, label_bestRecoZM, "Events"));
            ...
            vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_noZPtCut_50to250" + histSuffix,                  {dcData_Muon_LowDM_bestRecoZM_noZPtCut,                 dcMC_Muon_LowDM_bestRecoZM_noZPtCut},                   {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_noZPtCut_50to250" + histSuffix,                 {dcData_Muon_HighDM_bestRecoZM_noZPtCut,                dcMC_Muon_HighDM_bestRecoZM_noZPtCut},                  {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_noZPtCut_0to400" + histSuffix,                   {dcData_Muon_LowDM_bestRecoZM_noZPtCut,                 dcMC_Muon_LowDM_bestRecoZM_noZPtCut},                   {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_noZPtCut_0to400" + histSuffix,                  {dcData_Muon_HighDM_bestRecoZM_noZPtCut,                dcMC_Muon_HighDM_bestRecoZM_noZPtCut},                  {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_noZPtCut_50to250" + histSuffix,    {dcData_Muon_LowDM_bestRecoZM_noZPtCut,                 dcMC_Muon_LowDM_Normalization_bestRecoZM_noZPtCut},     {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_noZPtCut_50to250" + histSuffix,   {dcData_Muon_HighDM_bestRecoZM_noZPtCut,                dcMC_Muon_HighDM_Normalization_bestRecoZM_noZPtCut},    {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_noZPtCut_0to400" + histSuffix,     {dcData_Muon_LowDM_bestRecoZM_noZPtCut,                 dcMC_Muon_LowDM_Normalization_bestRecoZM_noZPtCut},     {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_noZPtCut_0to400" + histSuffix,    {dcData_Muon_HighDM_bestRecoZM_noZPtCut,                dcMC_Muon_HighDM_Normalization_bestRecoZM_noZPtCut},    {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_50to250" + histSuffix,                           {dcData_Muon_LowDM_bestRecoZM,                          dcMC_Muon_LowDM_bestRecoZM},                            {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_50to250" + histSuffix,                          {dcData_Muon_HighDM_bestRecoZM,                         dcMC_Muon_HighDM_bestRecoZM},                           {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_bestRecoZM_0to400" + histSuffix,                            {dcData_Muon_LowDM_bestRecoZM,                          dcMC_Muon_LowDM_bestRecoZM},                            {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_bestRecoZM_0to400" + histSuffix,                           {dcData_Muon_HighDM_bestRecoZM,                         dcMC_Muon_HighDM_bestRecoZM},                           {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_50to250" + histSuffix,             {dcData_Muon_LowDM_bestRecoZM,                          dcMC_Muon_LowDM_Normalization_bestRecoZM},              {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_50to250" + histSuffix,            {dcData_Muon_HighDM_bestRecoZM,                         dcMC_Muon_HighDM_Normalization_bestRecoZM},             {1, 2}, "", 40, 50.0, 250.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_LowDM_Normalization_bestRecoZM_0to400" + histSuffix,              {dcData_Muon_LowDM_bestRecoZM,                          dcMC_Muon_LowDM_Normalization_bestRecoZM},              {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
            vh.push_back(PHS("DataMC_Muon_HighDM_Normalization_bestRecoZM_0to400" + histSuffix,             {dcData_Muon_HighDM_bestRecoZM,                         dcMC_Muon_HighDM_Normalization_bestRecoZM},             {1, 2}, "", 400, 0.0, 400.0, 1.0e-1, 1.0e5,     true, doNorm, label_bestRecoZM, "Events"));
