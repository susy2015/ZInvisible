    ...
    */
    ...
    if (doSearchBins)
    {
        ...
        for (const auto& JetPtCut : JetPtCuts) 
        {
            ...
            // nGetPart
            vh.push_back(PHS("TTbar_MergedTop_nGenPart_recalc_nmteq0",  {dcMC_TTbar_MergedTop_nGenPart_recalc},                                                                 {1, 1}, "nMergedTops_jetpt30=0",   9, 0, 9,  true, false,  "MergedTop_nGenPart, nmt=0",     "Events", true));
            vh.push_back(PHS("TTbar_MergedTop_nGenPart_recalc_nmteq1",  {dcMC_TTbar_MergedTop_nGenPart_recalc},                                                                 {1, 1}, "nMergedTops_jetpt30=1",   9, 0, 9,  true, false,  "MergedTop_nGenPart, nmt=1",     "Events", true));
            vh.push_back(PHS("TTbar_MergedTop_nGenPart_recalc_nmtgeq2", {dcMC_TTbar_MergedTop_nGenPart_recalc},                                                                 {1, 1}, "nMergedTops_jetpt30>=2",  9, 0, 9,  true, false,  "MergedTop_nGenPart, nmt>=2",    "Events", true));
            // T1tttt
