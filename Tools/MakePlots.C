    ...
    */
    ...
    for (const auto& JetPtCut : JetPtCuts) 
    {
        ...
        if (doDataMCPhoton)
        {
            ...
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_53to56_lowmtb_nrtge1" + histSuffix,                          {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_53to56_lowmtb_nrtge1_Cuts,   myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_57to60_lowmtb_nrtge1" + histSuffix,                          {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_57to60_lowmtb_nrtge1_Cuts,   myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_53to56_lowmtb_nmtge1" + histSuffix,                          {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_53to56_lowmtb_nmtge1_Cuts,   myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_57to60_lowmtb_nmtge1" + histSuffix,                          {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_57to60_lowmtb_nmtge1_Cuts,   myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_53to56_lowmtb_nwge1" + histSuffix,                           {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_53to56_lowmtb_nwge1_Cuts,    myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_CRUnitBins_57to60_lowmtb_nwge1" + histSuffix,                           {dcData_Photon_HighDM_met,                                          dcMC_Photon_HighDM_met},                                            {1, 2},   CRUnitBins_57to60_lowmtb_nwge1_Cuts,    myCRUnitBinEdges,        true, doNorm, label_metWithPhoton, "Events"));
            // --- Study MET for different Nb --- //
            ...
            vh.push_back(PHS("DataMC_Photon_HighDM_nmt_nominal" + histSuffix,                                       {dcData_Photon_HighDM_nmt_nominal,                                  dcMC_Photon_HighDM_nmt_nominal},                                    {1, 2}, "", 6,  0,  6, true, doNorm, label_nmt, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_nrt_nominal" + histSuffix,                                        {dcData_Photon_LowDM_nrt_nominal,                                   dcMC_Photon_LowDM_nrt_nominal},                                     {1, 2}, "", 6,  0,  6, true, doNorm, label_nrt, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_nrt_nominal" + histSuffix,                                       {dcData_Photon_HighDM_nrt_nominal,                                  dcMC_Photon_HighDM_nrt_nominal},                                    {1, 2}, "", 6,  0,  6, true, doNorm, label_nrt, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_nj_nominal" + histSuffix,                                         {dcData_Photon_LowDM_nj_nominal,                                    dcMC_Photon_LowDM_nj_nominal},                                      {1, 2}, "", maxJets,  minJets,  maxJets, true, doNorm, label_nj, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_nj_nominal" + histSuffix,                                        {dcData_Photon_HighDM_nj_nominal,                                   dcMC_Photon_HighDM_nj_nominal},                                     {1, 2}, "", maxJets,  minJets,  maxJets, true, doNorm, label_nj, "Events"));
            // --- Standard Selection --- //
            ...
            vh.push_back(PHS("DataMC_Photon_LowDM_nj_nb0_rebin" + histSuffix,                                       {dcData_Photon_LowDM_nj_nb0,                                        dcMC_Photon_LowDM_nj_nb0},                                          {1, 2}, "", xbins_nj_nb0, true, doNorm, label_nj, "Events"));
            ...
            vh.push_back(PHS("DataMC_Photon_LowDM_ht" + histSuffix,                                                 {dcData_Photon_LowDM_ht,                                            dcMC_Photon_LowDM_ht},                                              {1, 2}, "", nBins,  minHT, maxHT,        true, doNorm, label_ht, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_ht_split" + histSuffix,                                           {dcData_Photon_LowDM_ht,                                            dcMC_Photon_LowDM_ht_split},                                        {1, 2}, "", nBins,  minHT, maxHT,        true, doNorm, label_ht, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_ht" + histSuffix,                                           {dcData_Photon_LowDM_Tight_ht,                                      dcMC_Photon_LowDM_Tight_ht},                                        {1, 2}, "", nBins,  minHT, maxHT,        true, doNorm, label_ht, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_ht" + histSuffix,                                                {dcData_Photon_HighDM_ht,                                           dcMC_Photon_HighDM_ht},                                             {1, 2}, "", nBins,  minHT, maxHT,        true, doNorm, label_ht, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_ht_split" + histSuffix,                                          {dcData_Photon_HighDM_ht,                                           dcMC_Photon_HighDM_ht_split},                                       {1, 2}, "", nBins,  minHT, maxHT,        true, doNorm, label_ht, "Events"));
            ...
            vh.push_back(PHS("DataMC_Photon_LowDM_PhotonPt" + histSuffix,                                           {dcData_Photon_LowDM_PhotonPt,                                      dcMC_Photon_LowDM_PhotonPt},                                        {1, 2}, "", 36, 220.0, 2020.0,           true, doNorm, label_PhotonPt, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_PhotonPt" + histSuffix,                                     {dcData_Photon_LowDM_Tight_PhotonPt,                                dcMC_Photon_LowDM_Tight_PhotonPt},                                  {1, 2}, "", 36, 220.0, 2020.0,           true, doNorm, label_PhotonPt, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_PhotonPt" + histSuffix,                                          {dcData_Photon_HighDM_PhotonPt,                                     dcMC_Photon_HighDM_PhotonPt},                                       {1, 2}, "", 36, 220.0, 2020.0,           true, doNorm, label_PhotonPt, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_PhotonEta" + histSuffix,                                          {dcData_Photon_LowDM_PhotonEta,                                     dcMC_Photon_LowDM_PhotonEta},                                       {1, 2}, "", nBins,  minEta, maxEta,      true, doNorm, label_PhotonEta, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_PhotonEta" + histSuffix,                                    {dcData_Photon_LowDM_Tight_PhotonEta,                               dcMC_Photon_LowDM_Tight_PhotonEta},                                 {1, 2}, "", nBins,  minEta, maxEta,      true, doNorm, label_PhotonEta, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_PhotonEta" + histSuffix,                                         {dcData_Photon_HighDM_PhotonEta,                                    dcMC_Photon_HighDM_PhotonEta},                                      {1, 2}, "", nBins,  minEta, maxEta,      true, doNorm, label_PhotonEta, "Events"));
            ...
            vh.push_back(PHS("DataMC_Photon_NoBaseline_dR_PromptPhotonGenParton" + histSuffix,                      {dcData_Photon_NoBaseline_dR_PromptPhotonGenParton,                 dcMC_Photon_NoBaseline_dR_PromptPhotonGenParton},                   {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_withQCDcut_dR_PromptPhotonGenParton" + histSuffix,           {dcData_Photon_NoBaseline_dR_PromptPhotonGenParton,                 dcMC_Photon_NoBaseline_withQCDcut_dR_PromptPhotonGenParton},        {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_0to10_dR_PromptPhotonGenParton" + histSuffix,                {dcData_Photon_NoBaseline_dR_PromptPhotonGenParton,                 dcMC_Photon_NoBaseline_dR_PromptPhotonGenParton},                   {1, 2}, "", nBins, 0.0, 10.0,            true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_0to10_withQCDcut_dR_PromptPhotonGenParton" + histSuffix,     {dcData_Photon_NoBaseline_dR_PromptPhotonGenParton,                 dcMC_Photon_NoBaseline_withQCDcut_dR_PromptPhotonGenParton},        {1, 2}, "", nBins, 0.0, 10.0,            true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_dR_PromptPhotonGenParton" + histSuffix,                           {dcData_Photon_LowDM_dR_PromptPhotonGenParton,                      dcMC_Photon_LowDM_dR_PromptPhotonGenParton},                        {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_dR_PromptPhotonGenParton" + histSuffix,                     {dcData_Photon_LowDM_Tight_dR_PromptPhotonGenParton,                dcMC_Photon_LowDM_Tight_dR_PromptPhotonGenParton},                  {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_dR_PromptPhotonGenParton" + histSuffix,                          {dcData_Photon_HighDM_dR_PromptPhotonGenParton,                     dcMC_Photon_HighDM_dR_PromptPhotonGenParton},                       {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_dR_RecoPhotonGenPhoton" + histSuffix,                             {dcData_Photon_LowDM_dR_RecoPhotonGenPhoton,                        dcMC_Photon_LowDM_dR_RecoPhotonGenPhoton},                          {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_dR_RecoPhotonGenPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_dR_RecoPhotonGenPhoton" + histSuffix,                       {dcData_Photon_LowDM_Tight_dR_RecoPhotonGenPhoton,                  dcMC_Photon_LowDM_Tight_dR_RecoPhotonGenPhoton},                    {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_dR_RecoPhotonGenPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_dR_RecoPhotonGenPhoton" + histSuffix,                            {dcData_Photon_HighDM_dR_RecoPhotonGenPhoton,                       dcMC_Photon_HighDM_dR_RecoPhotonGenPhoton},                         {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_dR_RecoPhotonGenPhoton, "Events"));
            ...
            vh.push_back(PHS("DataMC_Photon_NoBaseline_min_dR_PromptPhotonGenParton" + histSuffix,                  {dcData_Photon_NoBaseline_min_dR_PromptPhotonGenParton,             dcMC_Photon_NoBaseline_min_dR_PromptPhotonGenParton},               {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_withQCDcut_min_dR_PromptPhotonGenParton" + histSuffix,       {dcData_Photon_NoBaseline_min_dR_PromptPhotonGenParton,             dcMC_Photon_NoBaseline_withQCDcut_min_dR_PromptPhotonGenParton},    {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_0to10_min_dR_PromptPhotonGenParton" + histSuffix,            {dcData_Photon_NoBaseline_min_dR_PromptPhotonGenParton,             dcMC_Photon_NoBaseline_min_dR_PromptPhotonGenParton},               {1, 2}, "", nBins, 0.0, 10.0,            true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_NoBaseline_0to10_withQCDcut_min_dR_PromptPhotonGenParton" + histSuffix, {dcData_Photon_NoBaseline_min_dR_PromptPhotonGenParton,             dcMC_Photon_NoBaseline_withQCDcut_min_dR_PromptPhotonGenParton},    {1, 2}, "", nBins, 0.0, 10.0,            true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_min_dR_PromptPhotonGenParton" + histSuffix,                       {dcData_Photon_LowDM_min_dR_PromptPhotonGenParton,                  dcMC_Photon_LowDM_min_dR_PromptPhotonGenParton},                    {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_min_dR_PromptPhotonGenParton" + histSuffix,                 {dcData_Photon_LowDM_Tight_min_dR_PromptPhotonGenParton,            dcMC_Photon_LowDM_Tight_min_dR_PromptPhotonGenParton},              {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_min_dR_PromptPhotonGenParton" + histSuffix,                      {dcData_Photon_HighDM_min_dR_PromptPhotonGenParton,                 dcMC_Photon_HighDM_min_dR_PromptPhotonGenParton},                   {1, 2}, "", nBins, 0.0, 1.0,             true, false, label_min_dR_PromptPhotonGenParton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_min_dR_RecoPhotonGenPhoton" + histSuffix,                         {dcData_Photon_LowDM_min_dR_RecoPhotonGenPhoton,                    dcMC_Photon_LowDM_min_dR_RecoPhotonGenPhoton},                      {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_min_dR_RecoPhotonGenPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_Tight_min_dR_RecoPhotonGenPhoton" + histSuffix,                   {dcData_Photon_LowDM_Tight_min_dR_RecoPhotonGenPhoton,              dcMC_Photon_LowDM_Tight_min_dR_RecoPhotonGenPhoton},                {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_min_dR_RecoPhotonGenPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_min_dR_RecoPhotonGenPhoton" + histSuffix,                        {dcData_Photon_HighDM_min_dR_RecoPhotonGenPhoton,                   dcMC_Photon_HighDM_min_dR_RecoPhotonGenPhoton},                     {1, 2}, "", nBins, 0.0, 0.2,             true, false, label_min_dR_RecoPhotonGenPhoton, "Events"));
            vh.push_back(PHS("DataMC_Photon_LowDM_nCRUnitLowDM" + histSuffix,                                       {dcData_Photon_LowDM_nCRUnitLowDM,                                  dcMC_Photon_LowDM_nCRUnitLowDM},                                    {1, 2}, "", max_crunit_low_dm - min_crunit_low_dm,    min_crunit_low_dm,  max_crunit_low_dm,   true, false, "Control Region Unit Low DM",  "Events"));
            vh.push_back(PHS("DataMC_Photon_HighDM_nCRUnitHighDM" + histSuffix,                                     {dcData_Photon_HighDM_nCRUnitHighDM,                                dcMC_Photon_HighDM_nCRUnitHighDM},                                  {1, 2}, "", max_crunit_high_dm - min_crunit_high_dm,  min_crunit_high_dm, max_crunit_high_dm,  true, false, "Control Region Unit High DM", "Events"));
            ...
            for (int i = 0; i < 4; i++)
                ...
                vh.push_back(PHS(nameLowDM,          {dcVecData_Photon_LowDM_dPhi[i],       dcVecMC_Photon_LowDM_dPhi[i]},       {1, 2}, "", nBins,  0.0, maxPhi, true, doNorm, vec_label_dphi[i], "Events"));
                vh.push_back(PHS(nameLowDM_Tight,    {dcVecData_Photon_LowDM_Tight_dPhi[i], dcVecMC_Photon_LowDM_Tight_dPhi[i]}, {1, 2}, "", nBins,  0.0, maxPhi, true, doNorm, vec_label_dphi[i], "Events"));
                vh.push_back(PHS(nameHighDM,         {dcVecData_Photon_HighDM_dPhi[i],      dcVecMC_Photon_HighDM_dPhi[i]},      {1, 2}, "", nBins,  0.0, maxPhi, true, doNorm, vec_label_dphi[i], "Events"));
            }
