...
cachedir
cd $CMSSW_BASE/src/ZInvisible/Tools/full_root_files
cachedir
cd $CMSSW_BASE/src/ZInvisible/Tools/condor/.git
cachedir
cd $CMSSW_BASE/src/ZInvisible/Tools/condor/logs
cachedir
cd $CMSSW_BASE/src/ZInvisible/Tools/plots
cachedir
