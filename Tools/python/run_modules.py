...
def main():
    ...
    with open(json_file, "r") as input_file:
        ...
        for era in eras:
            ...
            # makeZvsPhoton(self, file_name, var, varPhoton, varLepton, era, rebin, useForSyst, doDataOverData=False, xbins = np.array([]), n_bins = 0, x_min=0, x_max=0)
            Syst.makeZvsPhoton(result_file, "met",  "metWithPhoton",                            "metWithLL",                                era, True,  True,  False, xbins_met, n_bins_met, 250.0, 1000.0)
            Syst.makeZvsPhoton(result_file, "met",  "metWithPhoton",                            "metWithLL",                                era, True,  False, True,  xbins_met, n_bins_met, 250.0, 1000.0)
            Syst.makeZvsPhoton(result_file, "ht",   "HT_drPhotonCleaned_jetpt30",               "HT_drLeptonCleaned_jetpt30",               era, True,  False, False, xbins_ht,  n_bins_ht,  300.0, 1000.0)
            Syst.makeZvsPhoton(result_file, "ht",   "HT_drPhotonCleaned_jetpt30",               "HT_drLeptonCleaned_jetpt30",               era, True,  False, True,  xbins_ht,  n_bins_ht,  300.0, 1000.0)
